  ...
  return (
    <div className="space-y-8 animate-in fade-in duration-500">
      <header className="flex flex-col gap-2">
        <h2 className="text-3xl md:text-4xl font-bold text-slate-800">Today's Outfit</h2>
        <p className="text-lg text-slate-600">Context-aware styling based on your needs.</p>
      </header>
      ...
      >
        <div className="flex items-center justify-between mb-4">
          <h3 className="text-xl font-bold text-slate-800">Current Context</h3>
        ...
        <div className="grid grid-cols-2 md:grid-cols-4 gap-4">
          <div className="flex flex-col items-center p-4 bg-slate-50 rounded-xl">
            ...
            <span className="text-sm text-slate-500">Chilly</span>
          </div>
          <div className="flex flex-col items-center p-4 bg-slate-50 rounded-xl">
            <CloudRain className="w-8 h-8 text-brand-skyblue mb-2" aria-hidden="true" />
            <span className="font-semibold">40%</span>
            <span className="text-sm text-slate-500">Rain Chance</span>
          </div>
          <div className="flex flex-col items-center p-4 bg-slate-50 rounded-xl">
      ...
      <section aria-label="Outfit Suggestion">
        <div className="flex flex-col md:flex-row gap-8">
          ...
          <div className="flex-1 bg-white p-6 rounded-2xl shadow-sm border border-slate-100 flex flex-col items-center justify-center min-h-[400px] relative">
            {isGenerating ? (
              <div className="flex flex-col items-center gap-4">
                <RefreshCw className="w-12 h-12 text-brand-teal animate-spin" />
                <p className="text-lg font-medium text-slate-600">Curating your accessible outfit...</p>
              </div>
            ) : (
                ...
                <div className="w-full max-w-sm flex flex-col gap-4">
                  ...
                  <div className="bg-brand-mustard/20 border-2 border-brand-mustard p-6 rounded-xl flex items-center gap-4">
                    ...
                    <div>
                      ...
                      <p className="text-slate-600 text-sm">Soft cotton, tagless, sensory-friendly.</p>
                    </div>
                  </div>
                  {/* Bottom */}
                  <div className="bg-slate-800/10 border-2 border-slate-800 p-6 rounded-xl flex items-center gap-4">
                    ...
                    <div>
                      ...
                      <p className="text-slate-600 text-sm">Stretchy waist, easy to put on, deep pockets.</p>
                    </div>
                  </div>
                  {/* Shoes */}
                  <div className="bg-brand-magenta/20 border-2 border-brand-magenta p-4 rounded-xl flex items-center gap-4">
                    ...
                    <div>
                      ...
                      <p className="text-slate-600 text-sm">No laces required.</p>
                    </div>
                  </div>
                </div>
              </div>
